...
public class TypefaceUtil {
     ...
     */
    public static void replaceFont(@androidx.annotation.NonNull android.view.View root, String fontPath) {
        if (root == null || TextUtils.isEmpty(fontPath)) {
            return;
        }


        if (root instanceof android.widget.TextView) { // If view is TextView or it's subclass, replace it's font
            android.widget.TextView textView = (android.widget.TextView)root;
     ...
     * @param fontPath font file path relative to 'assets' directory.
     */
    public static void replaceFont(@androidx.annotation.NonNull AppCompatActivity context, String fontPath) {
     ...
     */
    public static android.view.View getRootView(AppCompatActivity context)
    {
...
//    </style>
    public static void replaceSystemDefaultFont(@androidx.annotation.NonNull Context context, @androidx.annotation.NonNull String fontPath) {
