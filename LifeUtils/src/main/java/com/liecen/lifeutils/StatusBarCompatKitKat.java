...
public class StatusBarCompatKitKat {
     ...
     */
    private static android.view.View addFakeStatusBarView(AppCompatActivity activity, int statusBarColor, int statusBarHeight) {
        Window window = activity.getWindow();
        ViewGroup mDecorView = (ViewGroup) window.getDecorView();

        android.view.View mStatusBarView = new android.view.View(activity);
    ...
    private static void removeFakeStatusBarViewIfExist(AppCompatActivity activity) {
        ...
        android.view.View fakeView = mDecorView.findViewWithTag(TAG_FAKE_STATUS_BAR_VIEW);
        if (fakeView != null) {
     ...
     */
    private static void addMarginTopToContentChild(android.view.View mContentChild, int statusBarHeight) {
     ...
     */
    private static void removeMarginTopOfContentChild(android.view.View mContentChild, int statusBarHeight) {
        if (mContentChild == null) {
            return;
        }
        if (TAG_MARGIN_ADDED.equals(mContentChild.getTag())) {
    ...
    static void setStatusBarColor(AppCompatActivity activity, int statusColor) {
        ...
        android.view.View mContentChild = mContentView.getChildAt(0);
   ...
   public static void translucentStatusBar(AppCompatActivity activity) {
    ...
    static void setStatusBarColorForCollapsingToolbar(AppCompatActivity activity, final AppBarLayout appBarLayout, final CollapsingToolbarLayout collapsingToolbarLayout,
                                                      androidx.appcompat.widget.Toolbar toolbar, int statusColor) {
        Window window = activity.getWindow();
        window.addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        ViewGroup mContentView = (ViewGroup) window.findViewById(Window.ID_ANDROID_CONTENT);
        ...
        ((android.view.View) appBarLayout.getParent()).setFitsSystemWindows(false);
        ...
        final android.view.View statusView = addFakeStatusBarView(activity, statusColor, statusBarHeight);
