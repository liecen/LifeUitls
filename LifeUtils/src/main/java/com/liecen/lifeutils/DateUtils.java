...
/**
 * date工具类
 * 使用方式： String birthday = DateUtils.getTimeStr(DateUtils.YYYY_MM_DD, null, date.getTime());
 */
...
public class DateUtils {
    ...
    public static final String TIME_FORMAT_STRING = "yyyyMMddHHmmss";
    ...
    public static long convertToLong(String date, String format) {
        try {
            if (!StringUtils.isEmpty(date)) {
                ...
                SimpleDateFormat formatter = new SimpleDateFormat(format, java.util.Locale.getDefault());
    ...
    public static String convertToString(long time) {
        if (time > 0) {
            SimpleDateFormat formatter = new SimpleDateFormat(TIME_FORMAT, java.util.Locale.getDefault());
     ...
     * @return yyyy-MM-dd HH:mm:ss
     */
    public static String convertToStringNoSplit(long time) {
        if (time > 0) {
            SimpleDateFormat formatter = new SimpleDateFormat(TIME_FORMAT_STRING, java.util.Locale.getDefault());
            Date date = new Date(time);
            return formatter.format(date);
        }
        return "";
     ...
     * @return
     */
    public static String convertToString2(Date time) {
        if (time != null) {
            SimpleDateFormat formatter = new SimpleDateFormat(DATE_FORMAT, java.util.Locale.getDefault());
     ...
     * @return
     */
    public static String convertToString3(Date time) {
        if (time != null) {
            SimpleDateFormat formatter = new SimpleDateFormat(FORMAT_HH_MM, java.util.Locale.getDefault());
            return formatter.format(time);
        }
        return "";

    }
    public static String convertToString3(Long time) {
        if (time != null) {
            SimpleDateFormat formatter = new SimpleDateFormat(FORMAT_HH_MM, java.util.Locale.getDefault());
    ...
    public static long getTheFirstDayOfTheMonth() {
        Calendar calendar = Calendar.getInstance();
     ...
     * @return
     */
    public static long getGapCountMonth(Date fromDate, Date toDate) {
        ...
        if (fromYear == toYear) {
            return Math.abs(fromDateCal.get(Calendar.MONTH) - toDateCal.get(Calendar.MONTH)) + 1;
        } else {
            int fromMonth = 12 - (fromDateCal.get(Calendar.MONTH) + 1);
            int toMonth = toDateCal.get(Calendar.MONTH) + 1;
            return Math.abs(toYear - fromYear - 1) * 12 + fromMonth + toMonth + 1;
        }
    }
     ...
     * @return
     */
    public static int getGapCountDays(Date startDate, Date endDate) {
